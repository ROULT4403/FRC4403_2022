...
public class AutoBackUpAlpha extends SequentialCommandGroup {
  /** Creates a new AutoBackUp00. */
  public AutoBackUpAlpha(Drivetrain s_drivetrain, Index s_index, Shooter s_shooter, Hood s_hood, Turret s_turret) {
