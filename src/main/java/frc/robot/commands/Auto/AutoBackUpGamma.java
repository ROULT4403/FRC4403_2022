...
public class AutoBackUpGamma extends SequentialCommandGroup {
  /** Creates a new AutoBackUp01. */
  public AutoBackUpGamma(Drivetrain s_drivetrain, Index s_index, Shooter s_shooter, Hood s_hood, Turret s_turret, Intake s_intake) {
