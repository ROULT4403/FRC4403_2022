...
public class AutoBackUp1 extends SequentialCommandGroup {
  /** Creates a new AutoBackUp01. */
  public AutoBackUp1(Drivetrain s_drivetrain, Index s_index, Shooter s_shooter, Hood s_hood, Turret s_turret, Intake s_intake) {
    ...
    addCommands(
      ...
      new Shoot(s_index, s_shooter, s_hood, s_turret, 2500, 10, 0)
    );
  }
}
