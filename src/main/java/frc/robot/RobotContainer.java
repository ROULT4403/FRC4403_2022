...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // if(DriverStation.isJoystickConnected(1)){
      ...
      // Algorithm intake
      c_RB.whileHeld(new RunCommand(() -> s_intake.setIntake(0.3, true), s_intake).alongWith(new RunCommand(() -> s_index.setIndex(0.25, s_intake.detectedCargoIntake), s_index)));
